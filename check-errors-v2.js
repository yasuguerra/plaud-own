...
const cmd = 'gcloud logging read "resource.type=\\"cloud_run_revision\\" AND resource.labels.service_name=\\"plaud-corporate-app\\" AND timestamp >= \\"2026-06-10T00:19:07Z\\"" --limit=200 --project=plaud-own --format=json';
